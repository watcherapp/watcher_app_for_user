...
class VendorComponent extends StatefulWidget {
  var vandorData;
  Function onremove;
  VendorComponent({this.vandorData, this.onremove});
...
class _VendorComponentState extends State<VendorComponent> {
      ...
      child: Stack(
        children: [
          Row(
            ...
            children: [
              Text("${widget.vandorData["vendorCategoryName"]}"),
              GestureDetector(
                onTap: () {
                  _deletevendorCategory(widget.vandorData["_id"]);
                },
                child: Icon(
                  Icons.remove_circle,
  ...
  _deletevendorCategory(var vendorId) async {
    try {
      ...
      if (internetResult.isNotEmpty &&
        ...
        Services.responseHandler(
                apiName: "api/vendor/deleteVendorCategory", body: body)
            .then((responseData) {
